    ...
    <User_DashboardLayout>
      ...
      <div className="profile_wrapper">
        <div className="profile_picture">
          <div className="profile_bg"><img className="bg" src={bg} alt="" /></div>
          <div className="profile"><img src={pfp} alt="" /></div>
          <div className="user_detail">
            <h1>{user.name}</h1>
            <p><span>EnrollmentId: </span>{user.enrollmentId}</p>
            <div className="profile_btns">
              <div className="button-container">
              <Link to= "/user/setting">
                <span className="mask">Update</span>
                <button id='work' type="Submit" name="Hover">Update</button>
              </Link>
              </div>
            </div>
          </div>
